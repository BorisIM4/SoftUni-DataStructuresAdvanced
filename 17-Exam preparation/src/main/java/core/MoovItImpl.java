...
public class MoovItImpl implements MoovIt {
    private final Map<String, Route> routsById;

    private final Set<Route> routes;


    public MoovItImpl() {
        this.routsById = new LinkedHashMap<>();
    ...
    public void addRoute(Route route) {
        ...
        this.routsById.put(route.getId(), route);
        this.routes.add(route);
    }

    @Override
    public void removeRoute(String routeId) {
        Route result = this.routsById.remove(routeId);
    ...
    @Override
    public int size() {
        return this.routsById.size();
    }

    @Override
    public Route getRoute(String routeId) {
        Route result = this.routsById.get(routeId);
